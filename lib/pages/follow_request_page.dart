        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              // Choisir la bonne personne à afficher
              final userData = isSender
                  ? request['receiver']
                  : request['sender'];
              ...
              return ListTile(
                ...
                title: Text(
                  isSender ? "Request to $username" : "Request from $username",
                ),

                subtitle: Text("Status: $status\nCreated at: $createdAt"),

                // 🔥 Si c’est une requête envoyée → aucun bouton
                trailing: isSender
                    ? null
                    : Row(
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed: () =>
                                _acceptFollowRequest(request['id'], senderId),
                          ),
                          IconButton(
                            icon: const Icon(Icons.close, color: Colors.red),
                            onPressed: () =>
                                _rejectFollowRequest(request['id']),
                          ),
                        ],
                      ),
              );
